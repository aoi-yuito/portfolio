        ...
        <ul class="pt">
          ...
          <li>
            <a
              ...
              >omniSynq — A B2B SAAS to automate common business issues</a
            >
          </li>
          <li>
            <a
              ...
              >Apollo Cyclops — A heavy duty Discord Bot written in Python</a
            >
          </li>
          <li>
            <a
          ...
          <li>
            <a
              ...
              >A mysterious project about B2B SAAS again is coming soon...</a
            >
          </li>
        </ul>
      </article>
