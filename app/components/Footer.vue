  ...
  <div class="relative">
    ...
    >
      ...
      <div class="text-center">
        ...
        <div class="mt-3 font-extrabold footer-description">
          <p class="text-gray-400/80">
            Have a <span class="text-blue-200">project in mind?</span> Let's
            connect and build something extraordinary.<br />Built by me, for
            you. Let's create
        ...
        <div class="mt-1 space-x-2">
          <a
            ...
            href="https://www.facebook.com/yuito.aoi.2024"
            target="_blank"
          >
            <svg
          ...
          <a
            class="size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-gray-500 hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:text-neutral-400 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
            href="https://discord.com/users/714022418200657971"
            target="_blank"
          >
            <svg
              class="shrink-0 size-3.5"
...
onNuxtReady(() => {
  ...
  const init = () => {
    ...
    //renderer.setClearColor(0xeeeeee, 1.0); this is done to remove the white background color
